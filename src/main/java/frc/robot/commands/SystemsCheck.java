...
public class SystemsCheck extends SequentialCommandGroup {
    public SystemsCheck(EndEffectorSubsystem m_EndEffectorSubsystem, PivotSubsystem m_PivotSubsystem, SwerveSubsystem swerveSubsystem, ClimbSubsystem m_ClimbSubsystem) {
        addCommands(
                new InstantCommand(() -> Logger.recordOutput("SystemsCheck/Status", "Starting...")),
                
                // Swerve Tests
                new InstantCommand(() -> Logger.recordOutput("SystemsCheck/Status", "Testing Swerve Drive Forward...")),
                new ParallelDeadlineGroup(new WaitCommand(1),
                        swerveSubsystem.driveCommand(() -> 5, () -> 0, () -> 0)),

                new InstantCommand(() -> Logger.recordOutput("SystemsCheck/Status", "Testing Swerve Drive Strafe...")),
                new ParallelDeadlineGroup(new WaitCommand(1),
                        swerveSubsystem.driveCommand(() -> 0, () -> 5, () -> 0)),

                new InstantCommand(() -> Logger.recordOutput("SystemsCheck/Status", "Testing Swerve Drive Rotation...")),
                new ParallelDeadlineGroup(new WaitCommand(1),
                        swerveSubsystem.driveCommand(() -> 0, () -> 0, () -> 5)),
                new WaitCommand(0.5),

                // Pivot and EndEffector Test
                new InstantCommand(() -> Logger.recordOutput("SystemsCheck/Status", "Testing Intake Cycle...")),
                ...
                new InstantCommand(() -> {
                    if (!m_EndEffectorSubsystem.getIntaken()) {
                        Logger.recordOutput("SystemsCheck/Fault", "Intake failed to detect Coral within 10 Seconds!");
                    } else {
                ...
                new WaitUntilCommand(m_PivotSubsystem::atPosition),
                new InstantCommand(() -> Logger.recordOutput("SystemsCheck/Status", "Testing Release...")),
                ...
                // Climb Test
                new InstantCommand(() -> Logger.recordOutput("SystemsCheck/Status", "Testing Climb Up...")),
                new InstantCommand(m_ClimbSubsystem::climb),
                new WaitCommand(1),
                new InstantCommand(() -> Logger.recordOutput("SystemsCheck/Status", "Testing Climb Down...")),

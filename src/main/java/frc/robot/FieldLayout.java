...
public class FieldLayout {
    ...
    public static class ALGAE {
        public static final Pose2d AB = new Pose2d(Units.inchesToMeters(123.935946), Units.inchesToMeters(163.037678),
                Rotation2d.fromDegrees(0));
        public static final Pose2d CD = new Pose2d(Units.inchesToMeters(146.409216), Units.inchesToMeters(114.944904),
                Rotation2d.fromDegrees(60));
        public static final Pose2d EF = new Pose2d(Units.inchesToMeters(199.237790), Units.inchesToMeters(110.492543),
                Rotation2d.fromDegrees(120));
        public static final Pose2d GH = new Pose2d(Units.inchesToMeters(229.453741), Units.inchesToMeters(153.839701),
                Rotation2d.fromDegrees(180));
        public static final Pose2d IJ = new Pose2d(Units.inchesToMeters(207.172845), Units.inchesToMeters(201.812875),
                Rotation2d.fromDegrees(-120));
        public static final Pose2d KL = new Pose2d(Units.inchesToMeters(154.377247), Units.inchesToMeters(206.570858),
                Rotation2d.fromDegrees(-60));
